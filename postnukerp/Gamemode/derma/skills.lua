...
function GM.skills_window( ply )
	...
	--Class Specific Skill
		...
		Skills_DPanel.ClsSKLabel:SetText("Class Skills:")
			...
			if skill.class != nil then
				for classname, class in pairs( PNRP.Skills[skill.name].class ) do
					if tostring(ply:Team()) == tostring(class) then
						if SkillNOne == nil then 
							SkillNOne = skill.name
						else
							SkillNTwo = skill.name
						end
					end
				end
			end
		...
		if SkillNOne then
			Skills_DPanel.ClsSkillOne = vgui.Create("DLabel", Skills_DPanel)
			Skills_DPanel.ClsSkillOne:SetPos(10, 342)
			Skills_DPanel.ClsSkillOne:SetText(SkillNOne.." (Max Level "..PNRP.Skills[SkillNOne].maxlvl..")")
			Skills_DPanel.ClsSkillOne:SetColor( Color( 255, 255, 255, 255 ) )
			Skills_DPanel.ClsSkillOne:SizeToContents() 
			Skills_DPanel.ClsSkillOne:SetContentAlignment( 5 )
			UpSkillBtn(SkillNOne, btnXLoc, 340, Skills_DPanel)
			SKlevel_Bar(SkillNOne, GetSkill(SkillNOne), 10, 360, Skills_DPanel)
		end
		if SkillNTwo then
			Skills_DPanel.ClsSkillTwo = vgui.Create("DLabel", Skills_DPanel)
			Skills_DPanel.ClsSkillTwo:SetPos(10, 382)
			Skills_DPanel.ClsSkillTwo:SetText(SkillNTwo.." (Max Level "..PNRP.Skills[SkillNTwo].maxlvl..")")
			Skills_DPanel.ClsSkillTwo:SetColor( Color( 255, 255, 255, 255 ) )
			Skills_DPanel.ClsSkillTwo:SizeToContents() 
			Skills_DPanel.ClsSkillTwo:SetContentAlignment( 5 )
			UpSkillBtn(SkillNTwo, btnXLoc, 380, Skills_DPanel)
			SKlevel_Bar(SkillNTwo, GetSkill(SkillNTwo), 10, 400, Skills_DPanel)
		end
