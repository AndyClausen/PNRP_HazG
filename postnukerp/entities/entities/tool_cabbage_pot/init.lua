...
util.PrecacheModel ("models/props_c17/pottery06a.mdl")
...
function ENT:PlantUpdate()
	...
	if self.PlantStatus > 75 and self.FruitLevel < 1 then
		-- ent.FruitLevel = ent.FruitLevel + 1
		local fruitent = ents.Create("food_cabbage")
		fruitent:SetModel("models/foodnhouseholditems/cabbage1.mdl")
