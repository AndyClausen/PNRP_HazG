...
function ENT:Use( activator, caller )
	...
	if ( activator:IsPlayer() ) then
		activator:IncResource( "Small_Parts", self:GetAmount() )
		self:Remove()
	end
end
...
function ENT:Touch(ent)
	...
	if ent:GetClass() ~= "msc_smallnug" or self.USED or ent.USED or self.hasMerged or ent.hasMerged then return end
